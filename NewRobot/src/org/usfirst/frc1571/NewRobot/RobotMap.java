...
public class RobotMap {
    ...
    public static void init() {
        ...
        armMotorarmMotorController1 = new Jaguar(4);
        LiveWindow.addActuator("armMotor", "armMotorController 1", (Jaguar) armMotorarmMotorController1);
        
        armMotorarmMotorController2 = new Jaguar(5);
        LiveWindow.addActuator("armMotor", "armMotorController 2", (Jaguar) armMotorarmMotorController2);
